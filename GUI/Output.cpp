...
void Output::CreateDrawToolBar() const
{
	...
	MenuItemImages[ITM_SQ] = "images\\MenuItems\\Menu_Square.jpg";
	MenuItemImages[ITM_TRI] = "images\\MenuItems\\Menu_Triangle.jpg";
	MenuItemImages[ITM_HEX] = "images\\MenuItems\\Menu_Hexagon.jpg";
	MenuItemImages[ITM_CHANGE_COLOR] = "images\\MenuItems\\Menu_change_color.jpg";
	MenuItemImages[ITM_FILL_COLOR] = "images\\MenuItems\\Menu_FillColor.jpg";
	MenuItemImages[ITM_SEL] = "images\\MenuItems\\Menu_Select.jpg";
	...
	MenuItemImages[ITM_CLRALL] = "images\\MenuItems\\Menu_ClearAll.jpg";
...
void Output::CreatePlayToolBar() const
{
	...
	MenuItemImages[ITM_MISSING_SHAPE] = "images\\MenuItems\\Menu_Missing_Shape.jpg";
	MenuItemImages[ITM_MATCHING_SHAPE] = "images\\MenuItems\\Menu_Matching_Shape.jpg";
...
void Output::DrawSquare(Point P1, GfxInfo SquareGfxInfo, bool selected) const {
	...
	if (SquareGfxInfo.isFilled)
	{
		...
		style = FRAME;
	int arrx[4] = { P1.x - 50,P1.x + 50,P1.x + 50,P1.x - 50 };
	int arry[4] = { P1.y - 50,P1.y - 50,P1.y + 50,P1.y + 50, };
...
void Output::DrawHexagon(Point P1, GfxInfo HexGfxInfo, bool selected) const {
	...
	int arry[6];
	for (int i = 0; i < 6; i++) {
		double angle = cdPi * 2 * i / 6;
		arrx[i] = P1.x + (int)(50 * cos(angle));
		arry[i] = P1.y + (int)(50 * sin(angle));
	}
